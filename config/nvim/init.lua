...
-- Number of spaces that a tab characters appears as
vim.opt.tabstop = 4
...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function(_, opts)
      ...
      -- with nHTTP Strict Transport Security headerHTTP Strict Transport Security headervim-treesitter. You should go explore a few and see what interests you:
      --
